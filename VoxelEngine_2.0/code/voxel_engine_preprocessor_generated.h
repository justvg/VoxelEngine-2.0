...
"};\n"
"\n"
"layout (std140) uniform PointLightsInfo\n"
"{\n"
"												// base alignment	// aligned offset\n"
"	int PointLightCount;						// 4				// 0\n"
"	point_light PointLights[MAX_POINT_LIGHTS];  // 16				// 16 (4 -> 16)\n"
"};\n"
"\n"
"vec3 PointLightCalc(vec3 Normal, vec3 FragColor)\n"
"{\n"
...
"		LightIndex++)\n"
"	{\n"
"		vec3 P = PointLights[LightIndex].P;\n"
"		vec3 Color = PointLights[LightIndex].Color;\n"
"		vec3 Dir = normalize(P - Input.FragPosSim);\n"
"		float Distance = length(P - Input.FragPosSim);\n"
"		Diffuse += (max(dot(Dir, Normal), 0.0) * Color * FragColor) / (Distance*Distance);\n"
"	}\n"
"\n"
"	return(Diffuse);\n"
"}\n"
...
"\n"
"	vec3 PointLightsDiffuse = PointLightCalc(Normal, Color);\n"
"\n"
...
"		}\n"
"	}\n"
"	vec3 FinalColor = Ambient + (1.0 - ShadowFactor)*DiffuseDir + PointLightsDiffuse;\n"
