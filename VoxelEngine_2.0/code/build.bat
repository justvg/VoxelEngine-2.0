...
set CommonCompilerFlags=-MT -nologo -Gm- -GR- -EHa- -fp:fast -O2 -Oi -WX -W4 -wd4324 -wd4505 -wd4456 -wd4457 -wd4063 -wd4702 -wd4201 -wd4100 -wd4189 -wd4459 -wd4127 -wd4311 -wd4302 -wd4366 -FC -Z7 
...
set CommonLinkerFlags=-incremental:no -opt:ref user32.lib gdi32.lib shell32.lib Winmm.lib opengl32.lib glew32s.lib glfw3.lib -ignore:4099
